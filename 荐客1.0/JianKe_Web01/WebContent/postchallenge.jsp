...
<div id="div_all">
	...
	<form action="savepost.action?sid=${shopone.sid}" method="post" enctype="multipart/form-data">
		<div id="div_body">
			<div id="div_z1">
				<span style="font-family: '微软雅黑';font-size: 30px;">欢迎发布挑战者菜谱，先选择你要挑战的菜名吧</span>
			</div>
			<div id="div_z2">
				<div id="div_z2_top">
				...
				<div id="div_z2_center">
					...
					<div id="div_z2_center_down">
						<span style="margin-left:10%; width:50%;height:3%;">
							<select name="ctitle" onclick="choosecname()" style="width:50%;height:50px;">
								<c:forEach items="${goods}" var="gs">
									<span style="margin-left: 10%;font-size: 18px;font-family: '微软雅黑';"><option value="${gs.gname}">${gs.gname}</option></span>
								</c:forEach>
							</select>
						</span>
					</div>
				...
				<div id="div_z2_bottom">
					...
					<div id="div_z2_bottom_right">
						<img alt="" src="${shopone.image}" style="width: 60%;height:71%;">
						<p>&nbsp;</p>
						<p>该菜系所在店铺：${shopone.sname}</p>
					</div>
				</div>
			</div>
			<div id="div_z3">
		...
		<div id="div_cpbz">
			<c:choose>
				<c:when test="${empty CurrentUser}">
					<span style="margin-left:40%;color:red;"><a href="denglu.jsp">请登录后再发表菜谱</a></span>
				</c:when>
				<c:otherwise>
